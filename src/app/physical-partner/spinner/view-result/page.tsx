...
const ViewSpinnerResult = () => {
    useTitle("View Spinner Result Details");
        ...
        return (
            <div>
                ...
                <div className="bg-white rounded-md p-10 mt-2 mb-2">
                    ...
                    <div className='mt-4'>
                        <CommonDataTable columns={columns} data={physicalTraceabilitySpinner.physical_traceability_data_spinner_sample} pagination={false} count={physicalTraceabilitySpinner.physical_traceability_data_spinner_sample.length} />
                    </div>

                    <div className='row mt-5'>
                        <h2 className="text-l font-semibold">Uploaded Report:</h2>
                        <div className='mt-2 flex gap-2'>
                            {physicalTraceabilitySpinner.upload_report.map((report: any, i: number) => {
...
export default ViewSpinnerResult;