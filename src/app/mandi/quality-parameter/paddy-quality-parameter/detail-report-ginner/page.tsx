...
export default function Page() {
  ...
  const columns = [
    ...
    {
      name: <p className="text-[13px] font-medium">{translations?.mandiInterface?.ginlotNo}</p>,
            ...
            <div className="breadcrumb-inner light-bg">
              <div className="breadcrumb-left">
                <ul className="breadcrum-list-wrap">
                  ...
                  <li><NavLink href="/mandi/quality-parameter/paddy-quality-parameter/">Paddy Quality Parameter</NavLink></li>
                  <li>Detail Report</li>
                </ul>
              </div>
            </div>
                  ...
                  <div className="search-filter-row">
                    ...
                    <div className="customButtonGroup">
                      <button
                        ...
                        onClick={() => router.push("/mandi/quality-parameter/paddy-quality-parameter")}
                      >
                        Go Back
                      </button>
                    </div>
