...
const PhysicalTraceabilityGinnerViewSamples = () => {
    ...
    const fetchPhysicalTraceabilityGinnerSamples = async () => {
        try {
            const res = await API.get(`physical-traceability/mandi-samples?physicalTraceabilityGinnerId=${id}&limit=${limit}&page=${page}&search=${searchQuery}&pagination=true`);
            if (res.success) {
                setData(res.data);
                setCount(res.count);
            }
                        ...
                        <div className="breadcrumb-inner light-bg">
                            <div className="breadcrumb-left">
                                <ul className="breadcrum-list-wrap">
                                    ...
                                    <li>
                                        <Link href="/mandi/physical-traceability" className="active">
