...
export default function page() {
  ...
  const fetchTicketing = async () => {
    try {
      const res = await API.get(
        `ticketing?processor=Ginner&processorId=${MandiId}&search=${searchQuery}&processSale=${checkedDataCorrection}&from=${startDates ? startDates?.toISOString() : ""
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row: any) => (
        <NavLink
          href={`/mandi/ticketing/view-details?id=${row.id}`}
        >
                          ...
                          {Access.create &&
                            <div className="search-filter-right">
                              <button
                                ...
                                onClick={() =>
                                  router.push("/mandi/ticketing/add-ticket")
                                }
                              >
                                Create Ticket
                              </button>
