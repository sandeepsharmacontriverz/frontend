...
export default function Page() {
  ...
  useEffect(() => {
    if (MandiId && formData.dataCorrectionType === "Sale") {
      fetchSales();
      fetchTicketType("sales");
    } else if (MandiId && formData.dataCorrectionType === "Process") {
      fetchProcesses();
      fetchTicketType("process");
    }
  }, [MandiId, formData.dataCorrectionType]);
  ...
  const fetchSales = async () => {
    try {
      const response = await API.get(
        `mandi-process/sales?mandiId=${MandiId}`
      );
      if (response.success) {
  ...
  const handleSubmit = async (e: any) => {
    ...
    if (!hasErrors) {
      ...
      if (mainResponse.success) {
        ...
        router.push("/mandi/ticketing");
      }
      else {
        toasterError(mainResponse.error.code, 5000, MandiId)
      }
    } else {
      return;
    }
          ...
          <div className="breadcrumb-inner light-bg">
            <div className="breadcrumb-left">
              <ul className="breadcrum-list-wrap">
                ...
                <li>
                  <NavLink href="/mandi/ticketing">Ticketing</NavLink>
                </li>
          ...
          <div className="pt-10 w-100 d-flex justify-start customButtonGroup pb-5">
            <section>
              <button
                ...
                onClick={() => router.push("/mandi/ticketing")}
              >
                CANCEL
              </button>
            </section>
