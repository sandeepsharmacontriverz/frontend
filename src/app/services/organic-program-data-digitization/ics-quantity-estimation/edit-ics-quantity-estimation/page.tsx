...
const EditIcsQuantityEstimation = () => {
    useTitle("Edit Ics Quantity Estimation");
    ...
    const fetchIcsQuantityEstimation = async () => {
        const response = await API.get(`organic-program-data-digitization/ics-quantity-estimation/${id}`);
        if (response.success) {
            setFormData((prevData: FormDataState) => {
                return {
                    ...
                    ics_id: response.data.ics_id,
                    no_of_farmer: response.data.no_of_farmer,
                    total_area: response.data.total_area,
                    est_cotton_area: response.data.est_cotton_area,
                    estimated_lint: response.data.estimated_lint,
                    verified_row_cotton: response.data.verified_row_cotton,
                    verified_ginner: response.data.verified_ginner,
                    crop_current_season_id: response.data.crop_current_season_id,
                    organic_standard: response.data.organic_standard,
                    certification_body: response.data.certification_body,
                    scope_issued_date: response.data.scope_issued_date,
                    scope_certification_validity: response.data.scope_certification_validity,
                    scope_certification_no: response.data.scope_certification_no,
                    nop_scope_certification_no: response.data.nop_scope_certification_no,
                ...
                <div className="breadcrumb-inner light-bg">
                    <div className="breadcrumb-left">
                        <ul className="breadcrum-list-wrap">
                            ...
                            <li>Edit Ics Quantity Estimation</li>
                        </ul>
                    </div>
                </div>
            </div>
...
export default EditIcsQuantityEstimation;