...
const SpinnerStockReport: any = () => {
  ...
  const getReports = async () => {
    const url = `reports/get-spinner-cotton-stock-report?countryId=${checkedCountries}&spinnerId=${checkedSpinners}&programId=${checkedPrograms}&seasonId=${checkedSeasons}&brandId=${
  ...
  const handleExport = async () => {
    const url = `reports/export-spinner-cotton-stock-report?countryId=${checkedCountries}&spinnerId=${checkedSpinners}&programId=${checkedPrograms}&seasonId=${checkedSeasons}&brandId=${
      brandId ? brandId : checkedBrands
    ...
    try {
      ...
      if (response.success) {
        handleDownload(
          response.data,
          "Cotton Connect - Spinner Lint Cotton Stock Report",
          ".xlsx"
        );
  ...
  const fetchExportAll = async () => {
    ...
    const url = `reports/export-spinner-cotton-stock-report?exportType=all`;
    try {
      const response = await API.get(url);
      if (response.success) {
                ...
                <div className="w-100 mt-0">
                  <div className="customFormSet">
                    <div className="w-100">
                      ...
                      {isAPILoading && <Loader height={"30px"} />}
              ...
              <div className="farm-group-inner">
                <div className="table-form ">
                  ...
                  <CommonDataTable
                    ...
                    // fullCountLoader={true}
                    // fullCount={fullDataCount}
                  />
                </div>
              </div>
            </div>
