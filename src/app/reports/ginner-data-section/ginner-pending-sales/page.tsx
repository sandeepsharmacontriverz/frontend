...
const PendingSales: any = () => {
  ...
  const getReports = async () => {
    const url = `reports/get-gin-pending-sales-report?countryId=${checkedCountries}&ginnerId=${checkedGinners}&programId=${checkedPrograms}&seasonId=${checkedSeasons}&brandId=${
      brandId ? brandId : checkedBrands
    }&status=To be Submitted&search=${searchQuery}&page=${page}&limit=${limit}&pagination=true`;
    try {
  ...
  const handleExport = async () => {
    const url = `reports/export-pending-sales-report?countryId=${checkedCountries}&ginnerId=${checkedGinners}&programId=${checkedPrograms}&seasonId=${checkedSeasons}&brandId=${
      brandId ? brandId : checkedBrands
    ...
    try {
      ...
      if (response.success) {
        handleDownload(
                      response.data,
                      "Rice Traceability - Ginner Pending Sales Report",
                      ".xlsx"
                    );
      }
  ...
  const fetchExportAll = async () => {
      ...
      const url = `reports/export-pending-sales-report?exportType=all`;
