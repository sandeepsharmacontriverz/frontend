...
const PhysicalTraceabilityKnitterViewSamples = () => {
    ...
    const fetchPhysicalTraceabilityKnitterSamples = async () => {
        try {
            const res = await API.get(`physical-traceability/knitter-samples?physicalTraceabilityKnitterId=${id}&limit=${limit}&page=${page}&search=${searchQuery}&pagination=true`);
            if (res.success) {
                setData(res.data);
                setCount(res.count);
            }
    ...
    useEffect(() => {
        if (id) {
            fetchPhysicalTraceabilityKnitterSamples();
        }
                        ...
                        <div className="breadcrumb-inner light-bg">
                            <div className="breadcrumb-left">
                                <ul className="breadcrum-list-wrap">
                                    ...
                                    <li>
                                        <Link href="/reports/physical-traceability/knitter-report" className="active">
                                            Knitter Report
                                        </Link>
                                    </li>
                                    <li>View Samples</li>
...
export default PhysicalTraceabilityKnitterViewSamples;