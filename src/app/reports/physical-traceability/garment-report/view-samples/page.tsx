...
const PhysicalTraceabilityGarmentViewSamples = () => {
    ...
    const fetchPhysicalTraceabilityGarmentSamples = async () => {
        try {
            const res = await API.get(`physical-traceability/garment-samples?physicalTraceabilityGarmentId=${id}&limit=${limit}&page=${page}&search=${searchQuery}&pagination=true`);
            if (res.success) {
                setData(res.data);
                setCount(res.count);
            }
    ...
    useEffect(() => {
        if (id) {
            fetchPhysicalTraceabilityGarmentSamples();
        }
                        ...
                        <div className="breadcrumb-inner light-bg">
                            <div className="breadcrumb-left">
                                <ul className="breadcrum-list-wrap">
                                    ...
                                    <li>
                                        <Link href="/reports/physical-traceability/garment-report" className="active">
                                            Garment Report
                                        </Link>
                                    </li>
                                    <li>View Samples</li>
...
export default PhysicalTraceabilityGarmentViewSamples;