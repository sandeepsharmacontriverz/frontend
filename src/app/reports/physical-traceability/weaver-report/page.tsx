...
const PhysicalTraceabilityWeaverReport = () => {
    useTitle("Physical Tracebility Details - Weaver");
    ...
    const fetchPhysicalTraceabilityWeaverReport = async () => {
        try {
            const res = await API.get(`physical-traceability/weaver?limit=${limit}&page=${page}&search=${searchQuery}&pagination=true`);
            if (res.success) {
                setData(res.data);
                setCount(res.count);
            }
    ...
    useEffect(() => {
        fetchPhysicalTraceabilityWeaverReport();
    ...
    const columns = [
        ...
        },
        {
            ...
            cell: (row: any) => (
                <Link
                    href={`/reports/physical-traceability/weaver-report/view-samples?id=${row.id}`}
                        ...
                        <div className="breadcrumb-inner light-bg">
                            <div className="breadcrumb-left">
                                <ul className="breadcrum-list-wrap">
                                    ...
                                    <li>Reports</li>
                                    <li>Physical Traceability Reports</li>
                                    <li>Weaver Report</li>
                                </ul>
                            </div>
                        </div>
...
export default PhysicalTraceabilityWeaverReport;