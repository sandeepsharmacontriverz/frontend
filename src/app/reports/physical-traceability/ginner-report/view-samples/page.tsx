...
const PhysicalTraceabilityGinnerViewSamples = () => {
    ...
    const fetchPhysicalTraceabilityGinnerSamples = async () => {
        try {
            const res = await API.get(`physical-traceability/ginner-samples?physicalTraceabilityGinnerId=${id}&limit=${limit}&page=${page}&search=${searchQuery}&pagination=true`);
            if (res.success) {
                setData(res.data);
                setCount(res.count);
            }
    ...
    useEffect(() => {
        if (id) {
            fetchPhysicalTraceabilityGinnerSamples();
        }
                        ...
                        <div className="breadcrumb-inner light-bg">
                            <div className="breadcrumb-left">
                                <ul className="breadcrum-list-wrap">
                                    ...
                                    <li>
                                        <Link href="/reports/physical-traceability/ginner-report" className="active">
                                            Ginner Report
                                        </Link>
                                    </li>
                                    <li>View Samples</li>
...
export default PhysicalTraceabilityGinnerViewSamples;