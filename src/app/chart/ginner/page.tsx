...
export default function dashboard() {
  ...
  const fetchTopVillage = async () => {
    try {
      const res = await API.get("dashboard/mandi/top/village?" + getQueryParams());
      if (res.success) {
  ...
  const fetchTopSpinners = async () => {
    try {
      const res = await API.get("dashboard/mandi/top/spinners?" + getQueryParams());
      if (res.success) {
  ...
  const fetchProcuredProcessed = async () => {
    try {
      const res = await API.get("dashboard/mandi/procured/processed?" + getQueryParams());
      if (res.success) {
  ...
  const fetchProcuredSold = async () => {
    try {
      const res = await API.get("dashboard/mandi/lint/procured/sold?" + getQueryParams());
      if (res.success) {
  ...
  const fetchDataAll = async () => {
    try {
      const res = await API.get("dashboard/mandi/data/get/all?" + getQueryParams());
      if (res.success) {
        setDataAll(res.data);
      }
    } catch (error) {
