...
export default function page() {
  useTitle("View Third Party Inspection");
  ...
  const getWeaverData = async () => {
    const url = `third-party-inspection/get-third-party-inspection?id=${id}`;
    try {
    ...
    return (
      <div className="w-full text-xs px-3 ">
        <div className="flex w-full justify-between">
          <div className="w-1/2">
            <label>Third Party Inspection Name:</label>
          </div>
          <div className="w-1/2">
          ...
          <div className="breadcrumb-inner light-bg">
            <div className="breadcrumb-left">
              <ul className="breadcrum-list-wrap">
                ...
                <li>View Third Party Inspection</li>
              </ul>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-md p-4">
            ...
            {hasAccess?.edit && (
              <div className="search-filter-right">
                <button
                  ...
                  onClick={() =>
                    router.push(
                      `/settings/processor-registration/edit-processor?id=${id}&type=Third_Party_Inspection`
                    )
                  }
                >
                  Edit
          ...
          <div className="w-full ">
            <div className="flex lg:w-full gap-4 md:w-full sm:w-full ">
              <Accordian
                title={"Third Party Inspection Details"}
