  ...
  const fetchGinners = async () => {
    try {
      const res = await API.get(
        `mandi?countryId=${checkedCountries}&stateId=${checkedStates}&limit=${limit}&page=${page}&search=${searchQuery}&pagination=true`
      );
      if (res.success) {
        setData(res.data);
        setCount(res.count);
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row: any) => (
        <Link
          // legacyBehavior
          href={`/settings/processor-registration/mandi/view-mandi?id=${row.id}`}
        // passHref
        >
        ...
        <div className="breadcrumb-inner light-bg">
          <div className="breadcrumb-left">
            <ul className="breadcrum-list-wrap">
              ...
              <li>Settings</li>
              <li>
                <Link href="/settings/processor-registration">Mandi</Link>
              </li>
            </ul>
          </div>
        </div>
