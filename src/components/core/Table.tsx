...
const CommonDataTable: React.FC<CommonDataTableProps> = ({
  ...
  function Loader() {
    return (
      <div className="text-center w-full min-h-[calc(100vh-500px)] flex justify-center items-center">
        <div role="status">
          <svg
            aria-hidden="true"
